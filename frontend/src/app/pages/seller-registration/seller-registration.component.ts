...
@Component({
      ...
      <div class="registration-layout">
        ...
        <div class="banner-side">
          <div class="banner-content">
            ...
            <p>Tham gia cộng đồng người bán hàng lớn nhất Việt Nam. Mở rộng quy mô, tiếp cận hàng triệu khách hàng và tăng trưởng doanh thu vượt bậc.</p>
          ...
          <div class="registration-form-card">
            ...
            <form nz-form [formGroup]="sellerForm" (ngSubmit)="onSubmit()" nzLayout="vertical">
              <nz-form-item>
                ...
                <nz-form-control nzErrorTip="Vui lòng nhập tên shop của bạn!">
                  <nz-input-group [nzPrefix]="shopPrefix">
                    <input nz-input formControlName="shopName" placeholder="Ví dụ: SoftBee Official Store" />
                  </nz-input-group>
              ...
              <nz-form-item>
                ...
                <nz-form-control>
                  <textarea nz-input [nzAutosize]="{ minRows: 3, maxRows: 5 }" formControlName="description" placeholder="Giới thiệu ngắn gọn về shop của bạn..."></textarea>
                </nz-form-control>
              </nz-form-item>
              ...
              <nz-form-item>
                ...
                <nz-form-control nzErrorTip="Vui lòng cung cấp địa chỉ!">
                  <nz-input-group [nzPrefix]="addrPrefix">
                    <input nz-input formControlName="address" placeholder="Số nhà, tên đường, quận/huyện..." />
                  </nz-input-group>
              ...
              <div class="terms-agree">
                 Bằng việc nhấn đăng ký, bạn đã đồng ý với <a href="javascript:void(0)">Điều khoản dịch vụ</a> & <a href="javascript:void(0)">Chính sách bảo mật</a> của chúng tôi.
              </div>

              <button nz-button class="submit-btn" [nzType]="'primary'" [nzLoading]="loading" [disabled]="!sellerForm.valid">
                Hoàn tất đăng ký
              </button>
            </form>
          </div>
  ...
  styles: [`
    ...
    @media (max-width: 1100px) {
       ...
       .registration-layout { max-width: 550px; border-radius: 30px; }
       .form-side { padding: 40px; }
       .registration-form-card { padding: 0; }
    }
  `]
})
  ...
  onSubmit() {
    if (this.sellerForm.valid) {
      ...
      this.sellerRequestService.submitRequest(this.sellerForm.value).subscribe({
        next: () => {
          this.message.success('Registration submitted successfully! Please wait for admin approval.');
